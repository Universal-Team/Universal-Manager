...
BUILD		:=	build
SOURCES		:=	source source/json source/utils source/sound source/voltlib source/screens
DATA		:=	data
INCLUDES	:=	include include/json include/utils include/sound include/voltlib include/screens
GRAPHICS	:=	assets/gfx
#GFXBUILD	:=	$(BUILD)
ROMFS		:=	romfs
GFXBUILD	:=	$(ROMFS)/gfx
